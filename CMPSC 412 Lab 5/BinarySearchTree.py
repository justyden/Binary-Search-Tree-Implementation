...
tree1 = BinarySearchTree([4, 3, 2, 9, 10, 12, 14, 19, 30, 40, 1, 24])
# print(tree1.checkValid())
# tree1.rootNode.number = 100
# print(tree1.checkValid())
# tree2 = BinarySearchTree([31, 33, 67, 5, 41, 90, 61, 25, 29, 37])
# tree3 = combineTree(tree1, tree2)
# print(tree3.preOrderTraversal())
print(tree1.inOrderTraversal())
# tree1.removeValue(4)
# print(tree1.inOrderTraversal())
# print(tree1.maxValue())
# print(tree1.minValue())
print(tree1.findValue(9))
# print(tree1.findValue(40))
# print(tree1.preOrderTraversal())
# print(tree1.inOrderTraversal())
# print(tree1.postOrderTraversal())
# tree1.insertNode(12)
# print(tree1.preOrderTraversal())
# tree2 = BinarySearchTree([1, 5, 6, 15])
# tree3 = combineTree(tree1, tree2)
# print(tree3.preOrderTraversal())
